...
import parameter_search4
from parameter_search4 import gen_point
...
# setup logging
logging.basicConfig(filename='logs/hyperp_binary_glove_300x43.log', filemode='a+', level=logging.DEBUG)
# logging.disable(logging.CRITICAL)

root = '../thesis-shared/data/blp/word2vec/two_classes/'
# Paths
...
for attempt in range(1):
    ...
    # best so far
    l_current_parameters = [5, 7, 1, 6, 3, 9]
    ch_out_1, ch_out_2, \
