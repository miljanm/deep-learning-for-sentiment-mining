...
import parameter_search3
from parameter_search3 import gen_point
...
def forward(x_data, y_data, print_conf_matrix=False):
    ...
    if print_conf_matrix:
        print confusion_matrix(t.data, y.data.argmax(axis=1))
...
# setup logging
logging.basicConfig(filename='logs/hyperp_fine_glove_300x21.log', filemode='a+', level=logging.DEBUG)
...
root = '../thesis-shared/data/blp/glove/300d/five_classes/'
# Paths
...
for attempt in range(40):
    ...
    # best so far
    # l_current_parameters = [16, 20, 1, 7, 1, 8]
    ch_out_1, ch_out_2, \
    ...
    try:
        ...
        parameter_search3.history_x.append(l_current_parameters)
        parameter_search3.history_y.append(max_accuracy)
        parameter_search3.clf.fit(parameter_search3.history_x, parameter_search3.history_y)
