...
import parameter_search1
from parameter_search1 import gen_point
...
def evaluate_results(x_test, y_test, N_test, batchsize, max_len, print_conf_matrix=False):
    ...
    for i in xrange(0, N_test, batchsize):
        ...
        loss, acc, y = forward(x_batch, y_batch, print_conf_matrix=False)
        
	predictions.append(cuda.to_cpu(y.data).argmax(axis=1))
...
# setup logging
logging.basicConfig(filename='logs/hyperp_fine_w2v_300x21.log', filemode='a+', level=logging.DEBUG)
# logging.disable(logging.CRITICAL)

root = './data/blp/word2vec/five_classes/'
# Paths
...
for attempt in range(1):
    ...
    # best so far
    l_current_parameters = [23, 23, 5, 10, 3, 4]
    ch_out_1, ch_out_2, \
    ...
    try:
        ...
        parameter_search1.history_x.append(l_current_parameters)
        parameter_search1.history_y.append(max_accuracy)
        parameter_search1.clf.fit(parameter_search1.history_x, parameter_search1.history_y)
